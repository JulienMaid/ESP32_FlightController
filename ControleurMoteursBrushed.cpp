...
void ControleurMoteursBrushed::FixerNouvellesConsigne(uint16_t i_u16_ConsigneMoteurAvG,
    ...
    uint16_t i_u16_ConsigneMoteurArD)
{
  ...
  l_u16_RapportCyclique_AvG = map(i_u16_ConsigneMoteurAvG, 0, 100, 0, m_u32_RapportCycliqueMax);
  l_u16_RapportCyclique_AvD = map(i_u16_ConsigneMoteurAvD, 0, 100, 0, m_u32_RapportCycliqueMax);
  l_u16_RapportCyclique_ArG = map(i_u16_ConsigneMoteurArG, 0, 100, 0, m_u32_RapportCycliqueMax);
  l_u16_RapportCyclique_ArD = map(i_u16_ConsigneMoteurArD, 0, 100, 0, m_u32_RapportCycliqueMax);
